...
import { ILogItem, isCdp, isDap, LogLevel, wordToLogLevel } from "./model";
...
export const Controls: React.FC<{
	...
	const [highlightRows, setHighlightedRows] = React.useState<
		ReadonlySet<number>
	>(new Set());
